    ...
    <Routes>
        ...
        <Route element={lazyLoad(MAIN_LAYOUT.FILE_PATH)}>
            <Route element={lazyLoad(CENTER_CONTENT.FILE_PATH)}>
                ...
                <Route path={STATS.FULL_PATH} element={lazyLoad(STATS.FILE_PATH)}/>
                <Route path={ARTICLE.FUNCTIONS.ARTICLE_LIST.FULL_PATH} element={lazyLoad(ARTICLE.FUNCTIONS.ARTICLE_LIST.FILE_PATH)}/>
                <Route path={ARTICLE.FUNCTIONS.ARTICLE_LIST.FUNCTIONS.CREATE_ARTICLE.FULL_PATH} element={lazyLoad(ARTICLE.FUNCTIONS.ARTICLE_LIST.FUNCTIONS.CREATE_ARTICLE.FILE_PATH)}/>
                <Route path={ARTICLE.FUNCTIONS.ARTICLE_LIST.FUNCTIONS.UPDATE_ARTICLE.FULL_PATH} element={lazyLoad(ARTICLE.FUNCTIONS.ARTICLE_LIST.FUNCTIONS.UPDATE_ARTICLE.FILE_PATH)}/>
